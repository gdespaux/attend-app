...
public class HomeFragment extends android.support.v4.app.ListFragment implements ListView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Classes: " + currentDate);
     ...
     * */
    private void getTodayClasses(final boolean getAccountClasses) {
